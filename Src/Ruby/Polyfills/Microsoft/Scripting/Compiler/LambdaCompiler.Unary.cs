...
namespace System.Linq.Expressions.Compiler {
    ...
    partial class LambdaCompiler {
        ...
        private void EmitUnaryOperator(ExpressionType op, Type operandType, Type resultType) {
            bool operandIsNullable = TypeUtilsEx.IsNullableType(operandType);
            ...
            if (operandIsNullable) {
                switch (op) {
                    case ExpressionType.Not: {
                            ...
                            Type nnOperandType = TypeUtilsEx.GetNonNullableType(operandType);
                    ...
                    case ExpressionType.IsTrue: {
                            Debug.Assert(TypeUtilsEx.AreEquivalent(operandType, resultType));
                            ...
                            _ilg.Emit(OpCodes.Ldloca, loc);
                            _ilg.EmitGetValueOrDefault(operandType);
                            Type nnOperandType = TypeUtilsEx.GetNonNullableType(resultType);
                    ...
                    case ExpressionType.TypeAs:
                        ...
                        if (TypeUtilsEx.IsNullableType(resultType)) {
        ...
        private void EmitUnboxUnaryExpression(Expression expr) {
            ...
            Debug.Assert(node.Type.IsValueType && !TypeUtilsEx.IsNullableType(node.Type));
        ...
        private void EmitConvert(UnaryExpression node, CompilationFlags flags) {
            if (node.Method != null) {
                ...
                if (TypeUtilsEx.AreEquivalent(node.Operand.Type, node.Type)) {
