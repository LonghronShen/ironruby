...
namespace System.Linq.Expressions.Compiler {
    ...
    partial class LambdaCompiler {
        ...
        private void EmitCoalesceBinaryExpression(Expression expr) {
            ...
            if (TypeUtilsEx.IsNullableType(b.Left.Type)) {
        ...
        private void EmitNullableCoalesce(BinaryExpression b) {
            ...
            Type nnLeftType = TypeUtilsEx.GetNonNullableType(b.Left.Type);
            ...
            } else if (!TypeUtilsEx.AreEquivalent(b.Type, nnLeftType)) {
                _ilg.Emit(OpCodes.Ldloca, loc);
                _ilg.EmitGetValueOrDefault(b.Left.Type);
            ...
            if (!TypeUtilsEx.AreEquivalent(b.Right.Type, b.Type)) {
        ...
        private void EmitReferenceCoalesceWithoutConversion(BinaryExpression b) {
            ...
            if (!TypeUtilsEx.AreEquivalent(b.Left.Type, b.Type)) {
        ...
        private void EmitBranchComparison(bool branch, BinaryExpression node, Label label) {
            ...
            if (node.Method != null) {
                ...
                if (TypeUtilsEx.IsNullableType(node.Right.Type)) {
                ...
                if (TypeUtilsEx.IsNullableType(node.Left.Type)) {
                ...
                EmitBranchOp(!branchWhenEqual, label);
            } else if (TypeUtilsEx.IsNullableType(node.Left.Type) || TypeUtilsEx.IsNullableType(node.Right.Type)) {
        ...
        private static Expression GetEqualityOperand(Expression expression) {
            if (expression.NodeType == ExpressionType.Convert) {
                ...
                if (TypeUtilsEx.AreReferenceAssignable(convert.Type, convert.Operand.Type)) {
