...
namespace Microsoft.Scripting.ComInterop {
    internal sealed class ComInvokeBinder {
        ...
        internal ComInvokeBinder(
            ...
            Debug.Assert(TypeUtilsEx.AreReferenceAssignable(typeof(ComMethodDesc), method.Type), "method");
            Debug.Assert(TypeUtilsEx.AreReferenceAssignable(typeof(IDispatch), dispatch.Type), "dispatch");
