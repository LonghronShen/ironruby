...
namespace Microsoft.Scripting {
    ...
    internal static partial class Strings {
        ...
        internal static string FormatString(string fmt, params object[] parameters)
        {
    ...
    internal static partial class Error {
        internal static Exception TypeIsGeneric(Type type) {
            return new ArgumentException($"The given type \"{type.FullName}\" is generic.");
        }

        internal static Exception TypeContainsGenericParameters(Type type) {
            return new ArgumentException($"The given type \"{type.FullName}\" contains generic parameters.");
        }
